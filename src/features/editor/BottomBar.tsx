...
export const BottomBar = () => {
  ...
  const toggleEditor = () => {
    ...
    // gaEvent("toggle_fullscreen"); // Devre dışı bırakıldı
  };

  React.useEffect(() => {
    if (data?.name) window.document.title = `${data.name} | MEROOT Visualizer`;
  }, [data]);
      ...
      <StyledLeft>
        ...
        <StyledBottomBarItem
          onClick={() => {
            ...
            // gaEvent("toggle_live_transform"); // Devre dışı bırakıldı
          }}
        >
