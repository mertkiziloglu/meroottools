...
const EditorPage = () => {
  ...
  return (
    <>
      <NextSeo
        {...SEO}
        title="Editor | MEROOT Visualizer"
        description="MEROOT Visualizer Editor is a tool for visualizing into graphs, analyzing, editing, formatting, querying, transforming and validating JSON, CSV, YAML, XML, and more."
